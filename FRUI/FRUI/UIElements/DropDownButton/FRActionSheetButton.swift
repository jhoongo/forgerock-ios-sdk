...
public class FRActionSheetButton: UIButton {
    ...
    #if SWIFT_PACKAGE
    fileprivate var indicatorView: UIImageView = UIImageView(image: UIImage(named: "arrow", in: Bundle.module, compatibleWith: nil))
    #else
    fileprivate var indicatorView: UIImageView = UIImageView(image: UIImage(named: "arrow", in: Bundle.init(for: FRDropDownButton.self), compatibleWith: nil))
    #endif
